...
@section('content')
    <div class="min-h-screen flex items-center justify-center bg-cover bg-center"
        ...
        <div class="bg-white/20 backdrop-blur-lg shadow-xl rounded-2xl p-8 w-full max-w-md text-white">
            <h2 class="text-3xl font-bold text-center mb-6">Daftar <span class="text-green-400">AgriMatch</span></h2>
            ...
            <form method="POST" action="{{ route('register.post') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <select name="role" required
                        class="w-full p-2 rounded-lg border border-white/30 bg-green-50 text-black focus:outline-none focus:ring-2 focus:ring-green-400">
